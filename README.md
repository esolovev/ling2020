...
| 10 | Олег | 27.11.2020 11:10 | Принцип «разделяй и властвуй». Сортировка слиянием. Быстрая сортировка. Бинарный поиск. |
| 11 | Лена | 02.12.2020 9:30 | Композиция и агрегация. Абстракция данных, инкапсуляция, наследование, полиморфизм.|
...
| 17 | Лена | TBA | Абстрактные классы. Статические методы и методы классов (модуль abc).|
| 18 | Егор | TBA | Абстрактный тип данных. Очередь, стек, связный список, массив, очередь с приоритетом. |
| 19 | Лена | TBA | Абстрактные классы. Статические методы и методы классов (модуль abc). |
