...
| 03 | Олег | TBA | Linux, bash и их друзья. | 
| 04 | Олег | TBA | Задача сортировки массива. Наивные и квадратичные алгоритмы сортировки. Сложность алгоритмов. Устойчивость сортировок и дополнительные затраты на память. | 
| 05 | Олег | TBA | Linux, bash и их друзья. | 
| 06 | Олег | TBA | Задача сортировки массива. Наивные и квадратичные алгоритмы сортировки. Сложность алгоритмов. Устойчивость сортировок и дополнительные затраты на память. |
| 07 | Егор | TBA | Итераторы и генераторы. |
| 08 | Олег | TBA | Принцип «разделяй и властвуй». Сортировка слиянием. Быстрая сортировка. Бинарный поиск. |
| 09 | Егор | TBA | Итераторы и генераторы. |
| 10 | Олег | TBA | Принцип «разделяй и властвуй». Сортировка слиянием. Быстрая сортировка. Бинарный поиск. |
| 11 | Лена | TBA | Класс, объект. Конструктор и деструктор. Композиция и агрегация. Абстракция данных, инкапсуляция, наследование, полиморфизм.|
...
| 21 | Лена | TBA | Декораторы. Абстрактные классы. Статические методы и методы классов (модуль abc). |
| 22 | Егор | TBA | Ассоциативный массив. Хэш-таблицы, словари, множества.|
| 23 | Лена | TBA | Декораторы. Абстрактные классы. Статические методы и методы классов (модуль abc). |
