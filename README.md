...
| Номер  | Преподаватель  | Дата  | Тема  | Материалы |
|---|---|---|---|---|
| 17 | Егор | 11.01.2021 11:10 | Абстрактный тип данных. Очередь, стек, связный список, массив, очередь с приоритетом. |
...
| 03  | Сортировки, визуализация деревьев  | 30 января 23:59  | [ссылка](https://github.com/oserikov/py-3k-hw1/README.md) |
